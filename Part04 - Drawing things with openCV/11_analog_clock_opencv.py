...
for i in range(0, 12):
    cv2.line(image, array_to_tuple(hours_orig[i]), array_to_tuple(hours_dest[i]), constant_colors.BLACK, 3)

# We draw a big circle, corresponding to the shape of the analog clock
cv2.circle(image, (320, 320), 310, constant_colors.DARK_GRAY, 8)

# We draw the rectangle containig texts:
cv2.rectangle(image, (150, 175), (490, 270), constant_colors.DARK_GRAY, -1)
cv2.putText(image, "This is a clock", (150, 200), 1, 2, constant_colors.LIGHT_GRAY, 1, cv2.LINE_AA)
cv2.putText(image, "with Python", (210, 250), 1, 2, constant_colors.LIGHT_GRAY, 1, cv2.LINE_AA)
